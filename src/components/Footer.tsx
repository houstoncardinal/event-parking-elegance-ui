      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              {[
                { name: 'Wedding Valet', path: '/wedding-valet' },
                { name: 'Corporate Events', path: '/corporate-events' },
                { name: 'Private Parties', path: '/private-parties' },
                { name: 'Premium Protection', path: '/premium-protection' },
            ...
            <ul className="space-y-5">
              <li className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="tel:(346)764-9163" className="text-slate-300 text-sm hover:text-gold-400 transition-colors">(346) 764-9163</a>
                </div>
              </li>
              <li className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-gradient-to-br from-gold-500/20 to-gold-600/20 rounded-full flex items-center justify-center border border-gold-400/20 flex-shrink-0">
